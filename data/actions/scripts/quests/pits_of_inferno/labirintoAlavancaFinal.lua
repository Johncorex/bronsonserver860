-- Alavanca UID 6628: puxa (1945->1946), remove pedra 387 em {1432,652,11},
-- após 30 min volta a alavanca (1946->1945) e recria a pedra.

local STONE_POS = Position(1421, 621, 10)
local STONE_ID  = 1304
local RESET_MS  = 60 * 60 * 1000 -- 30 minutos
...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
    ...
    if item.uid ~= 6628 or item.itemid ~= 1945 then
        return false
    end
