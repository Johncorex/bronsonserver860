...
local levelmin = 1
local levelmax = 12
local mission_id = 3002
--local new_mission_id = 3002

local bonus_exp = 900

--strings
local mission_complete = 'Bem-vindo a Edoras... Vou te dar 900 pontos de experiencia para adiantar as coisas... A saida da cidade e logo aqui ao norte.'
