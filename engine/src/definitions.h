...
static constexpr auto STATUS_SERVER_NAME = "Bronson Project";
static constexpr auto STATUS_SERVER_VERSION = "by Miguel Oliveira";
static constexpr auto STATUS_SERVER_DEVELOPERS = "Miguel Oliveira";
