...
public:
    ...
    // Converting constructor: allow rebinding from other T types
    template <typename U>
    constexpr LockfreePoolingAllocator(const LockfreePoolingAllocator<U, CAPACITY>&) noexcept {}

    // Mandatory rebind template for C++17 allocator requirements
    template <typename U>
    struct rebind {
...
// Partial specialization for void, so that allocator_traits<void> rebinding works
...
#endif // FS_LOCKFREE_H_8C707AEB7C7235A2FBC5D4EDDF03B008
