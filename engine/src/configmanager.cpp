...
bool ConfigManager::load()
{
	...
	boolean[APPLY_ITEM_SPECIALSKILLS] = getGlobalBoolean(L, "apply_item_specialskills", true);
	...
	string[CRITICAL_TEXT] = getGlobalString(L, "criticalText", "CRITICAL!");
	string[LIFELEECH_TEXT] = getGlobalString(L, "lifeLeechText", "LEECH!");
	string[MANALEECH_TEXT] = getGlobalString(L, "manaLeechText", "MANA LEECH!");
	integer[CRITICAL_EFFECT] = getGlobalNumber(L, "criticalEffect", CONST_ME_BLOODYSTEPS);
	integer[CRITICAL_COLOR] = getGlobalNumber(L, "criticalColor", TEXTCOLOR_RED);
	integer[LIFELEECH_EFFECT] = getGlobalNumber(L, "lifeLeechEffect", CONST_ME_MAGIC_RED);
	integer[LIFELEECH_COLOR] = getGlobalNumber(L, "lifeLeechColor", TEXTCOLOR_LIGHTGREEN);
	integer[MANALEECH_EFFECT] = getGlobalNumber(L, "manaLeechEffect", CONST_ME_MAGIC_BLUE);
	integer[MANALEECH_COLOR] = getGlobalNumber(L, "manaLeechColor", TEXTCOLOR_LIGHTBLUE);
	integer[CRITICAL_AMOUNT_DEFAULT] = getGlobalNumber(L, "criticalDefaultAmount", 100);
	integer[LIFELEECH_AMOUNT_DEFAULT] = getGlobalNumber(L, "lifeLeechDefaultAmount", 10);
	integer[MANALEECH_AMOUNT_DEFAULT] = getGlobalNumber(L, "manaLeechDefaultAmount", 10);
